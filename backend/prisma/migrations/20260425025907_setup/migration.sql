-- Baseline schema: candidate-centered tables (profile, education, work history, resumes).
-- Generated by Prisma migrate; aligns with the initial `Candidate`-family models.
